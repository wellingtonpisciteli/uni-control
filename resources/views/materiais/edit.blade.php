...
<div class="border-t border-gray-200 bg-gray-50 px-5 py-5 sm:px-6">
...
<div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
    ...
    <div class="w-full sm:w-auto">
        ...
        @if($material->ativo)
            ...
            <form
                id="desativar-form"
                action="{{ route('materiais.desativar', $material) }}"
                method="POST"
            >
    ...
    <div class="grid w-full grid-cols-2 gap-3 sm:flex sm:w-auto">
        ...
        <a
            href="{{ route('materiais.index') }}"
            class="inline-flex min-h-11 items-center justify-center rounded-xl border border-gray-300 bg-white px-5 text-sm font-semibold text-gray-700 shadow-sm transition hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-100"
        >
...
<div class="relative w-full max-w-md overflow-hidden rounded-2xl bg-white shadow-2xl">
    ...
    <div class="flex flex-col-reverse gap-3 border-t border-gray-100 bg-gray-50 px-6 py-4 sm:flex-row sm:justify-end">
        ...
        <button
            ...
            class="inline-flex min-h-11 items-center justify-center rounded-xl bg-orange-500 px-5 text-sm font-semibold text-white shadow-sm transition hover:bg-orange-600"
        >
    ...
    */
    ...
    function confirmarStatus()
    {
        @if($material->ativo)
            ...
            document
                .getElementById('desativar-form')
                .submit();

        @else

            document
                .getElementById('reativar-form')
                .submit();
